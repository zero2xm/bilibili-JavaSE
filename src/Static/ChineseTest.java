...
/*
        ...
        关于java中的static关键字：
            ...
            2、static修饰的方法是静态方法
            3、static修饰的变量是静态变量
            4、所有static修饰的元素都称为静态的，都可以使用"类名."的方式访问，当然也可以用"引用."的方式【但不推荐】
...
public class ChineseTest {
    ...
    //国籍【每一个对象由"ChineseTest"实例化的，所以每一个中国人的国籍都是"中国"】
    //无论通过Chinese类实例化多少个java对象，这些java对象的国籍都是"中国"
    //实例变量【实例变量时一个java对象就有一份，100个java对象，就有100个country】，分析这种方式有什么缺点
    ...
    //构造函数
    public ChineseTest(){}
    public ChineseTest(String id,String name){
        this.id = id;
        this.name = name;
    }
}
