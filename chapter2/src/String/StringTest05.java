...
public class StringTest05 {
    public static void main(String[] args) {
        ...
        //字符串比较大小不能直接使用> < ，需要使用compareTO()方法。
        ...
        System.out.println("http://www.baidu.com".contains("http://"));//false

        //4.(掌握).boolean endsWith(String suffix)
        //判断当前字符串是否以某个字符串结尾。
        System.out.println("test.txt".endsWith(".java"));//false
        System.out.println("test.txt".endsWith(".txt"));//true
        System.out.println("fasdfdasfsss".endsWith("ss"));//true

        //5.(掌握) boolean equals(Object anObject)
        //比较两个字符串必须使用equals方法，不能使用"=="
        //equals方法有没有调用compareTo方法？新版本没有调用compareTo()方法
        //equals只能看出相等不相等
        ...
        System.out.println("ABX".equalsIgnoreCase("aBx"));//true
        ...
        System.out.println("oraclejavac++.net#phppythonjavaoraclec++".indexOf("java"));//6
        ...
        String newString2 = "name=zs&password=123&age=20".replace("=",":");
        ...
        String param = "name=zs&password=123&age=20";
        ...
        //转换为小写
        String aaa = "ABCDefKXyz".toLowerCase();
        ...
        //20.(掌握) String trim();
        //去除字符串前后空白
        System.out.println("       hellow world!       ".trim());

        //21(掌握).String中只有一个方法是静态的,不需要ned对象
        //这个方法叫做valueof
        //作用：将"非字符串"转换成"字符串"
        ...
        System.out.println(s3);//没有重写toString()方法之前是对象内存地址。

        //println()方法的源代码
        //通过源代码可以看出：为什么输出一个引用的时候，会调用toString()方法！
        //本质上System.out.println()这个方法在输出任何数据的时候都是先转换称字符串，再输出。
